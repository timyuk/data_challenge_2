...
df = pd.read_pickle(r"data/PAS.pkl")
...
df_ward = pd.read_pickle(r"data/PAS_ward.pkl")
...
geojson = gpd.read_file(r'data/merged_boroughs.geojson')
...
geojson_wards = gpd.read_file(r'data/wards.geojson')
